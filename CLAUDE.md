...
Ferramenta interna de prospecção automatizada para um único freelancer
de desenvolvimento. Coleta estabelecimentos, diagnostica presença
digital, prioriza por score e gera mensagens de outreach via Claude API.
