...
Ferramenta interna de prospecção para um freelancer de desenvolvimento.
Coleta estabelecimentos via Google Places, identifica quem tem presença
digital fraca (sem site, site lento, sem HTTPS), prioriza cada um por um
score e usa a Claude API pra escrever o texto que inicia a conversa com
cada Lead.
...
Não é SaaS. Usuário único. Tudo síncrono na Fase 1.
